...
// processWork ensures the orchestrator is running for a work unit.
// This is non-blocking - it spawns the orchestrator and returns immediately.
func processWork(proj *project.Project, workID string) error {
	...
	if spawned {
		...
		fmt.Println("Orchestrator is already running.")
	}
