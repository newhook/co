...
SELECT id, work_id, task_type, scheduled_at, executed_at, status, error_message, metadata, created_at, updated_at FROM scheduler
...
SELECT id, work_id, task_type, scheduled_at, executed_at, status, error_message, metadata, created_at, updated_at FROM scheduler WHERE id = ?
`
