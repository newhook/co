...
// Ensure, that BeadsCLIMock does implement beads.CLI.
// If this is not the case, regenerate this file with moq.
var _ beads.CLI = &BeadsCLIMock{}

// BeadsCLIMock is a mock implementation of beads.CLI.
//
//	func TestSomethingThatUsesCLI(t *testing.T) {
//
//		// make and configure a mocked beads.CLI
...
//			},
//			CreateFunc: func(ctx context.Context, opts beads.CreateOptions) (string, error) {
...
//			},
//			UpdateFunc: func(ctx context.Context, beadID string, opts beads.UpdateOptions) error {
//				panic("mock out the Update method")
//			},
//		}
//
//		// use mockedCLI in code that requires beads.CLI
...
func (mock *BeadsCLIMock) Create(ctx context.Context, opts beads.CreateOptions) (string, error) {
	callInfo := struct {
		Ctx  context.Context
		Opts beads.CreateOptions
	}{
...
func (mock *BeadsCLIMock) Update(ctx context.Context, beadID string, opts beads.UpdateOptions) error {
	callInfo := struct {
		Ctx    context.Context
		BeadID string
		Opts   beads.UpdateOptions
...
// Ensure, that BeadsReaderMock does implement beads.Reader.
// If this is not the case, regenerate this file with moq.
var _ beads.Reader = &BeadsReaderMock{}

// BeadsReaderMock is a mock implementation of beads.Reader.
//
//	func TestSomethingThatUsesReader(t *testing.T) {
//
//		// make and configure a mocked beads.Reader
//		mockedReader := &BeadsReaderMock{
//			GetBeadFunc: func(ctx context.Context, id string) (*beads.BeadWithDeps, error) {
//				panic("mock out the GetBead method")
//			},
//			GetBeadWithChildrenFunc: func(ctx context.Context, id string) ([]beads.Bead, error) {
//				panic("mock out the GetBeadWithChildren method")
//			},
//			GetBeadsWithDepsFunc: func(ctx context.Context, beadIDs []string) (*beads.BeadsWithDepsResult, error) {
//				panic("mock out the GetBeadsWithDeps method")
//			},
//			GetReadyBeadsFunc: func(ctx context.Context) ([]beads.Bead, error) {
//				panic("mock out the GetReadyBeads method")
//			},
//			GetTransitiveDependenciesFunc: func(ctx context.Context, id string) ([]beads.Bead, error) {
//				panic("mock out the GetTransitiveDependencies method")
//			},
//			ListBeadsFunc: func(ctx context.Context, status string) ([]beads.Bead, error) {
//				panic("mock out the ListBeads method")
//			},
//		}
//
//		// use mockedReader in code that requires beads.Reader
//		// and then make assertions.
//
//	}
...
func (mock *BeadsReaderMock) GetBead(ctx context.Context, id string) (*beads.BeadWithDeps, error) {
	callInfo := struct {
		Ctx context.Context
		ID  string
	}{
	...
	if mock.GetBeadFunc == nil {
		var (
			beadWithDepsOut *beads.BeadWithDeps
			errOut          error
		)
...
func (mock *BeadsReaderMock) GetBeadWithChildren(ctx context.Context, id string) ([]beads.Bead, error) {
	callInfo := struct {
		Ctx context.Context
		ID  string
	}{
...
func (mock *BeadsReaderMock) GetBeadsWithDeps(ctx context.Context, beadIDs []string) (*beads.BeadsWithDepsResult, error) {
	callInfo := struct {
		Ctx     context.Context
		BeadIDs []string
	}{
	...
	if mock.GetBeadsWithDepsFunc == nil {
		var (
			beadsWithDepsResultOut *beads.BeadsWithDepsResult
			errOut                 error
		)
...
func (mock *BeadsReaderMock) GetReadyBeads(ctx context.Context) ([]beads.Bead, error) {
	callInfo := struct {
		Ctx context.Context
	}{
		Ctx: ctx,
...
func (mock *BeadsReaderMock) GetTransitiveDependencies(ctx context.Context, id string) ([]beads.Bead, error) {
	callInfo := struct {
		Ctx context.Context
		ID  string
	}{
...
func (mock *BeadsReaderMock) ListBeads(ctx context.Context, status string) ([]beads.Bead, error) {
	callInfo := struct {
		Ctx    context.Context
		Status string
	}{
