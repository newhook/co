...
// Ensure, that GitHubClientMock does implement github.ClientInterface.
// If this is not the case, regenerate this file with moq.
var _ github.ClientInterface = &GitHubClientMock{}

// GitHubClientMock is a mock implementation of github.ClientInterface.
//
//	func TestSomethingThatUsesClientInterface(t *testing.T) {
//
//		// make and configure a mocked github.ClientInterface
...
//		}
//
//		// use mockedClientInterface in code that requires github.ClientInterface
...
func (mock *GitHubClientMock) GetPRMetadata(ctx context.Context, prURLOrNumber string, repo string) (*github.PRMetadata, error) {
	callInfo := struct {
		Ctx           context.Context
		PrURLOrNumber string
		Repo          string
	...
	if mock.GetPRMetadataFunc == nil {
		var (
			pRMetadataOut *github.PRMetadata
			errOut        error
		)
...
func (mock *GitHubClientMock) GetPRStatus(ctx context.Context, prURL string) (*github.PRStatus, error) {
	callInfo := struct {
		Ctx   context.Context
		PrURL string
	}{
