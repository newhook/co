...
// Ensure, that ComplexityEstimatorMock does implement task.ComplexityEstimator.
// If this is not the case, regenerate this file with moq.
var _ task.ComplexityEstimator = &ComplexityEstimatorMock{}

// ComplexityEstimatorMock is a mock implementation of task.ComplexityEstimator.
//
//	func TestSomethingThatUsesComplexityEstimator(t *testing.T) {
//
//		// make and configure a mocked task.ComplexityEstimator
...
//		}
//
//		// use mockedComplexityEstimator in code that requires task.ComplexityEstimator
