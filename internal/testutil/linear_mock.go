...
// Ensure, that LinearClientMock does implement linear.ClientInterface.
// If this is not the case, regenerate this file with moq.
var _ linear.ClientInterface = &LinearClientMock{}

// LinearClientMock is a mock implementation of linear.ClientInterface.
//
//	func TestSomethingThatUsesClientInterface(t *testing.T) {
//
//		// make and configure a mocked linear.ClientInterface
//		mockedClientInterface := &LinearClientMock{
//			GetIssueFunc: func(ctx context.Context, issueIDOrURL string) (*linear.Issue, error) {
//				panic("mock out the GetIssue method")
//			},
//			GetIssueCommentsFunc: func(ctx context.Context, issueID string) ([]linear.Comment, error) {
//				panic("mock out the GetIssueComments method")
//			},
//			ListIssuesFunc: func(ctx context.Context, filters map[string]any) ([]*linear.Issue, error) {
//				panic("mock out the ListIssues method")
//			},
//			SearchIssuesFunc: func(ctx context.Context, searchQuery string, filters map[string]any) ([]*linear.Issue, error) {
//				panic("mock out the SearchIssues method")
//			},
//		}
//
//		// use mockedClientInterface in code that requires linear.ClientInterface
...
func (mock *LinearClientMock) GetIssue(ctx context.Context, issueIDOrURL string) (*linear.Issue, error) {
	callInfo := struct {
		Ctx          context.Context
		IssueIDOrURL string
	}{
...
func (mock *LinearClientMock) GetIssueComments(ctx context.Context, issueID string) ([]linear.Comment, error) {
	callInfo := struct {
		Ctx     context.Context
		IssueID string
	}{
...
func (mock *LinearClientMock) ListIssues(ctx context.Context, filters map[string]any) ([]*linear.Issue, error) {
	callInfo := struct {
		Ctx     context.Context
		Filters map[string]any
	}{
...
func (mock *LinearClientMock) SearchIssues(ctx context.Context, searchQuery string, filters map[string]any) ([]*linear.Issue, error) {
	callInfo := struct {
		Ctx         context.Context
		SearchQuery string
		Filters     map[string]any
